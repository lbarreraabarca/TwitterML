...
do
	...
	make run IN=$input WORD=$path_output"keywords/keywords.word" OUT=$path_output"label/"$output_file".csv" TS=$(cat $path_output"horaCrisis/tsMinutos.tm") TW="20" TSF=$path_output"frecuenciaSerie/analisis-hora/frecuencia/serie" TSM=$path_output"frecuenciaSerie/analisis-hora/modelo/model"
